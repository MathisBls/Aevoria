...
import cartItemRoutes from './routes/cart/cartItem.routes';
import orderRoutes from './routes/orders/order.routes';
import orderItemRoutes from './routes/orders/orderItem.routes';
...
app.get('/api-docs/order-service/swagger.json', (req: Request, res: Response) => {
...
const swaggerUiHandler = swaggerUi.setup(null, {
  ...
  swaggerOptions: {
    url: '/api-docs/order-service/swagger.json',
...
app.use('/api-docs/order-service', swaggerUi.serve, swaggerUiHandler);
...
server.listen(PORT, () => {
  ...
  console.log(`Order Service API docs: http://localhost:${PORT}/api-docs/order-service`);
  console.log(`Order Service health: http://localhost:${PORT}/health`);
});
